#ui\forms\accounting\widgets\jalali_date_input.py

"""
ویجت ورود تاریخ شمسی پیشرفته - نسخه یکپارچه برای ماژول حسابداری
"""
...
class JalaliDateInputAccounting(QWidget):
    """
    ...
    # در کلاس JalaliDateInputAccounting، متد get_date را اصلاح کنید:
...
class JalaliCalendarDialog(QDialog):
    ...
    def create_jalali_date_widget(mode='edit', **kwargs):
        ...
        Args:
            ...
            **kwargs: سایر پارامترهای JalaliDateInputAccounting
        
        Returns:
            JalaliDateInputAccounting
        """
        return JalaliDateInputAccounting(mode=mode, **kwargs)
